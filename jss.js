var Jogando    = false; // Identifica se há um jogo ocorrendo ou não.
  var Msg_Padrao = "Clique em 'Iniciar jogo' para iniciar"; // Mensagem padrão da barra de mensagens do jogo.
  ...
  function PC_Jogar() {
    ...
    if (!VerResultado())  {
      ...
      Vez = "USU";
      QUADRO.MENSG.value = "Aguardando o usuário jogar...";
    }
  }
  ...
  function FocarBotao() {
    // Seleciona o botão "Iniciar jogo" ao iniciar a página.
    QUADRO.BTJOGAR.focus();
  }
 
  function BTJOGAR_Click()  {
    /* Esta função verificar qual ação será tomada pelo botão 'Iniciar jogo':
  ...
  function IniciarJogo()  {
    /* Esta função dá inicio ao jogo,
       desabilitando a escolha da letra e alterando o botão 'Iniciar jogo' para
       'Parar jogo'
    */
    ...
    if (QUADRO.ESCOLHA.value=="") {
      ...
      QUADRO.BTJOGAR.value       = "Parar jogo"; // Altera o botão 'Iniciar jogo' para 'Parar jogo'
      QUADRO.BTJOGAR.style.color = "#DD0000";   // Muda a cor do texto do botão 'Iniciar jogo' para vermelho.
  ...
  function PararJogo()  {
    ...
    */
    if (confirm("Deseja mesmo parar o jogo agora?"))  {  // Solicita confirmação para interromper o jogo.
      ...
      QUADRO.BTJOGAR.value       = "Iniciar jogo"; // Altera o botão 'Parar jogo' para 'Iniciar jogo'.
      QUADRO.BTJOGAR.style.color = "#0000DD"; // Muda a cor do texto do botão 'Iniciar jogo' para azul.
